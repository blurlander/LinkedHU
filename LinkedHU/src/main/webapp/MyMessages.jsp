...
<body
	...
	<div id="kt_header_mobile"
		...
		<div class="kt-header-mobile__logo">
			<a href="demo9/index.html"> <img alt="Logo"
				...
				<div id="kt_header" class="kt-header  kt-header--fixed "
					...
					<div class="kt-container  kt-container--fluid ">
						...
						<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
							...
							<a class="kt-header__brand-logo" href="demo9/index.html"> <img
								alt="Logo" src="./assets/media/logos/4060logos.png" />
						...
						<div class="kt-header__topbar kt-grid__item">
								...
								<div
									...
									<div
										...
										<div class="kt-quick-search__wrapper kt-scroll"
											data-scroll="true" data-height="325" data-mobile-height="200">
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								...
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown"
									data-offset="10px,0px">
									<span id="hiSpan"
										class="kt-header__topbar-welcome kt-visible-desktop">Hi,</span>

									<span id="hiNameSpan"
										class="kt-header__topbar-username kt-visible-desktop">
										<c:out value="${currentUser.username }"></c:out>
									</span> <img alt="Pic" src="${currentUser.profilePictureSrc}"
								...
								<div
									...
									<div
										...
										<div class="kt-user-card__avatar">
											<img class="kt-hidden-" alt="Pic"
												src="${currentUser.profilePictureSrc}"
												style="border-top-left-radius: 50% 50%; border-top-right-radius: 50% 50%; border-bottom-right-radius: 50% 50%; border-bottom-left-radius: 50% 50%;" />
											<!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
											<span
												class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold kt-hidden">S</span>
									...
									<div class="kt-notification">
										...
										<!-- GO TO MY PROFILE -->
										<form id="myProfileClick" action="UserController"
											method="POST">

											<a href="javascript:{}" class="kt-notification__item"
												onclick="document.getElementById('myProfileClick').submit();">
												<div class="kt-notification__item-icon">
													<i class="flaticon2-calendar-3 kt-font-success"></i>
												</div>
												<div class="kt-notification__item-details">
													<div class="kt-notification__item-title kt-font-bold">
														My Profile <input type="hidden"
															value="${MyConstants.OPP_VIEW_PROFILE }" name="operation">
										...
										<a href="#" class="kt-notification__item">
											...
											<div class="kt-notification__item-details">
												<div class="kt-notification__item-title kt-font-bold">
													My Messages</div>
												<div class="kt-notification__item-time">Inbox and
													tasks</div>
											</div>
										</a>
						...
						<div id="kt_aside_menu" class="kt-aside-menu "
							...
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__section ">
									<h4 class="kt-menu__section-text">Pages</h4> <i
								...
								<li class="kt-menu__item " aria-haspopup="true"><a href="#"
									class="kt-menu__link "> <i
										...
										class="kt-menu__link-text">Home Page</span>
								</a></li>

								<li class="kt-menu__item " aria-haspopup="true"><a href="#"
									class="kt-menu__link "> <i
										class="kt-menu__link-icon fa fa-user"></i> <span
										class="kt-menu__link-text">Profile</span>
								</a></li>
							</ul>
						...
						<div class="kt-footer__wrapper">
							...
							<div class="kt-footer__menu">
								<a href="#" target="_blank" class="kt-link">About</a> <a
									href="#" target="_blank" class="kt-link">Team</a> <a href="#"
									target="_blank" class="kt-link">Contact</a>
